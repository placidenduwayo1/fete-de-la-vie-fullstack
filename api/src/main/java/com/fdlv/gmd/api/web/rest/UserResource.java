...
import com.fdlv.gmd.api.web.rest.errors.BadRequestAlertException;
import com.fdlv.gmd.api.web.rest.errors.EmailAlreadyUsedException;
import com.fdlv.gmd.api.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody ManagedUserVM userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            mailService.sendGMDCreationEmail(newUser);
    ...
    public ResponseEntity<AdminUserDTO> updateUser(@Valid @RequestBody ManagedUserVM userDTO) {
        ...
        return HttpUtils.wrapOrNotFound(updatedUser);
    }
    ...
    public ResponseEntity<AdminUserDTO> getUser(@PathVariable @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
        ...
        return HttpUtils.wrapOrNotFound(userService.getUserWithAuthoritiesByLogin(login).map(AdminUserDTO::new));
    }
    ...
    /**
     * {@code GET /user/:id} : get the user by his id .
     *
    ...
    public ResponseEntity<AdminUserDTO> getUserByid(@PathVariable Long id) {
        ...
        return HttpUtils.wrapOrNotFound(userService.getUserLoginById(id).map(AdminUserDTO::new));
    }
