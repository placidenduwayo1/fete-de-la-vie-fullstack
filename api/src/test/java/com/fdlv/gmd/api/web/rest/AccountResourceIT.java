...
import static com.fdlv.gmd.api.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import com.fdlv.gmd.api.dto.PasswordChangeDTO;
...
import com.fdlv.gmd.api.web.rest.AccountResource;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        authorityRepository.saveAndFlush(new Authority(AuthoritiesConstants.ADMIN));
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        ManagedUserVM user = new ManagedUserVM(testUser4.get());
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        User user = new User();
        user.setLogin("badguy");
        user.setEmail("badguy@example.com");
        ...
        verify(mailService).sendGMDActivationEmail(any());
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        //when(userService.getUserWithAuthorities()).thenReturn()
