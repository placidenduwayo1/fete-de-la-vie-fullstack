package com.fdlv.gmd.api.config.timezone;
...
import com.fdlv.gmd.api.repository.timezone.DateTimeWrapper;
import com.fdlv.gmd.api.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM gmd_date_time_wrapper where id=%d", fieldName, id);
    }
